            ...
            <div className="hero row">
                <div className="hero__text">
                    <div class="hero__text--primary">
                        ...
                        <p>I'm a Full-Stack Developer located in Ghana, dedicated to creating immersive and visually appealing web applications through meticulously crafted code and a user-centric design approach.</p>
